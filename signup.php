...
if($_SERVER["REQUEST_METHOD"]=='POST'){
  ...
  if($password == $cpassword){
    ...
    if(!$user){
      $signup = $funObj->SignUp($username,$email,$password);
      if($signup){
        echo "<script>alert('Registration successfull')</script>";
      } else{echo "<script>alert('Registration not successfull')</script>";}
...
<form action ="signup.php" method = "post">
  ...
  <div class="form-group">
    ...
    <small id="emailHelp" class="form-text text-muted">Make sure password must be same.</small>
  </div>
